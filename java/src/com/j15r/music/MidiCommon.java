...
public class MidiCommon {
   ...
   * input devices.
   * 
   * @param strDeviceName the name of the device for which an info object should
   *          be retrieved.
   * 
   ...
   * the number printed in the listDevicesAndExit method. If index is too small
   * or too big, null is returned.
   * 
